...
public class GFG2
{
    ...
    static int longestUniqueSubsttr(String str)
    {
        ...
        for(i = 1; i < n; i++)
        {
            ...
            System.out.println(str.charAt(i)+" prev index:"+prev_index+" curlenght:"+cur_len);
          ...
          //  System.out.println(cur_len);
            ...
            else
            {
                ...
                System.out.println(" prev index:"+prev_index+" curlenght:"+cur_len+" index:"+i);
            }
